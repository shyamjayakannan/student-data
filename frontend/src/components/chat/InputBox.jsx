    ...
    return (
        <div className={`${props.className} ${classes.container}`}>
            <div className={classes.containerSub}>
                <span ref={spanRef} data-ref="wow" placeholder="Type or paste your message here" onKeyUp={submit1} onKeyDown={seto} className={classes.input} role="textbox" contentEditable />
